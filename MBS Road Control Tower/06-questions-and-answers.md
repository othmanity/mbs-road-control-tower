...
> **62 bilingual (EN+AR) Q&A pairs** the MBS Road Control Tower Agent must answer reliably.
...
| 06 | [Contractors & governance](#6-contractors-governance) | 6 |
| 07 | [Vendor performance](#7-vendor-performance) | 8 |
| 08 | [Budget](#8-budget) | 4 |
| 09 | [Hajj readiness](#9-hajj-readiness) | 4 |
| 10 | [Activity types](#10-activity-types) | 4 |
| 11 | [Scope & safety](#11-scope-safety) | 3 |
...
ما طول محور طريق الأمير محمد بن سلمان وأين يمتد؟
...
كم عدد المركبات التي تستخدم الطريق يومياً؟
...
لماذا يُعد هذا المحور استراتيجياً؟
...
ما القطاعات الجغرافية الثلاثة للطريق؟
...
كيف يُقسَّم المحور إلى مراحل ونطاقات؟
...
ما النطاقات المشمولة في المرحلة التجريبية؟
...
ما الفرق بين المرحلة والقطاع الجغرافي؟
...
ما تصنيفات كثافة التشوه المستخدمة على الخريطة؟
...
كم عدد مستهدفات 2027 التي نتابعها؟
...
ما مستهدف تغطية صيانة الطريق وأين وصلنا؟
...
ما تقدّمنا في إصلاح الحواجز الخرسانية؟
...
أي مستهدف هو الأقرب للمسار المخطط؟
...
كم مبنى ملغى الصك ما زال يحتاج للهدم؟
...
ما مستهدف إزالة الورش غير النظامية؟
...
كم عدد الملاحظات المفتوحة ضمن نطاق التجربة؟
...
ما الملاحظات عالية الخطورة ولا زالت مفتوحة؟
...
أي تصنيف للتشوه يحوي أكثر عدد من الملاحظات؟
...
أي ملاحظة هي الأقرب لتاريخ موعدها المستهدف؟
...
كم ملاحظة أُعيد فتحها أكثر من مرة؟
...
كم عدد ملاحظات النطاق 8 وكم منها مفتوحة؟
...
أي نطاق تجريبي يحوي أكثر ملاحظات عالية الخطورة؟
...
هل توجد كباري في أي نطاق تجريبي؟
...
ماذا يمكنك إخباري عن النطاق 50؟
...
ما الأصول الموجودة في النطاق 35؟
...
## 6. Contractors & governance

المقاولون والحوكمة

### `A-01` Which contractors are involved on the MBS Road?

أي مقاولين يعملون على محور طريق الأمير محمد بن سلمان؟

**Answer (EN):** Ten in total: six government-internal entities (MoMAH — governance owner, HCM, JM, RGA, GDT, GDCD) and four private-sector vendors (Al-Rajhi Construction — ARC, Saudi Binladin Group — SBG, MA'AS Services — MAAS, and Tatweer Investment Partner — TIP).

**Answer (AR):** عشرة إجمالاً: ستة جهات حكومية داخلية (MoMAH — مالك الحوكمة، HCM، JM، RGA، GDT، GDCD) وأربعة مقاولين من القطاع الخاص (شركة الراجحي للإنشاءات — ARC، مجموعة بن لادن السعودية — SBG، ماس للخدمات — MAAS، وشريك تطوير الاستثمار — TIP).

---

### `A-02` Which contractor owns the most findings overall?

أي مقاول يحمل أكبر عدد من الملاحظات؟

**Answer (EN):** Take the largest entry of findings_aggregate.by_contractor — currently TIP and MAAS share the lead with 5 each, followed by ARC at 4.

**Answer (AR):** انظر أكبر إدخال في findings_aggregate.by_contractor — حالياً TIP و MAAS يتشاركان الصدارة بـ 5 ملاحظات لكل منهما، يليهما ARC بـ 4.

---

### `A-03` Which contractor has the most blocked items?

أي مقاول لديه أكثر بنود متعثرة؟

**Answer (EN):** Compare contractors[*].blocked_findings_count and take the max — currently RGA and HCM each have 1 blocked item open.

**Answer (AR):** قارن contractors[*].blocked_findings_count — حالياً RGA و HCM لدى كل منهما بند متعثر واحد مفتوح.

---

### `A-04` Why does the report say governance is one of the four root causes?

لماذا يقول التقرير إن الحوكمة هي أحد الأسباب الجذرية الأربعة؟

**Answer (EN):** Because no single authority oversees the corridor end-to-end — 4 contractors involved in maintenance, 7 in infrastructure projects, 3 in studies, 4 in private-sector projects. Roles overlap and there is no joint operations room (slide 9).

**Answer (AR):** لأنه لا توجد جهة واحدة مشرفة على المحور كاملاً — 4 مقاولين في الصيانة، 7 في البنية التحتية، 3 في الدراسات، 4 في القطاع الخاص. تتداخل الأدوار ولا توجد غرفة عمليات مشتركة (شريحة 9).

---

### `A-05` What is the proposed governance fix?

ما الحل الحوكمي المقترح؟

**Answer (EN):** An independent program led by MoMAH that joins HCM (Makkah) and Jeddah Municipality in a shared working room with mandates for findings remediation, vendor performance oversight, and stakeholder coordination.

**Answer (AR):** برنامج مستقل بقيادة MoMAH يجمع HCM (مكة) وأمانة جدة في غرفة عمل مشتركة بصلاحيات معالجة الملاحظات، ومتابعة أداء المقاولين، وتنسيق أصحاب المصلحة.

---

### `A-06` Who is responsible for greenery and ad-board concessions?

من المسؤول عن التشجير وامتيازات اللوحات الإعلانية؟

**Answer (EN):** Tatweer Investment Partner (TIP) — a PPP vendor — under MoMAH oversight.

**Answer (AR):** شريك تطوير الاستثمار (TIP) — مقاول شراكة بين القطاعين العام والخاص — تحت إشراف MoMAH.
...
### `V-01` Who is our best-performing vendor overall?

من هو أفضل مقاول من حيث الأداء بشكل عام؟

**Answer (EN):** Use vendor_performance.best_overall — based on a composite score that weights on-time delivery (40%), quality (30%), low fines (20%), and few late items (10%).

**Answer (AR):** انظر vendor_performance.best_overall — مبني على نتيجة مركبة تزن الالتزام بالمواعيد (40%)، الجودة (30%)، انخفاض الغرامات (20%)، وقلة البنود المتأخرة (10%).

---

### `V-02` Which vendor has the most fines this year?

أي مقاول لديه أكبر مبلغ غرامات هذا العام؟

**Answer (EN):** Use vendor_performance.most_fined — Al-Rajhi Construction (ARC) leads at SAR 450,000 YTD, followed by Tatweer Investment Partner (TIP) at SAR 320,000.

**Answer (AR):** انظر vendor_performance.most_fined — شركة الراجحي للإنشاءات (ARC) في المقدمة بـ 450,000 ر.س منذ بداية العام، يليها شريك تطوير الاستثمار (TIP) بـ 320,000 ر.س.

---

### `V-03` Which vendor is slipping on deadlines / has the most late findings?

أي مقاول متأخر عن المواعيد / لديه أكثر بنود متأخرة؟

**Answer (EN):** Use vendor_performance.most_late — Tatweer Investment Partner (TIP) currently has the most late findings (3), followed by RGA (3) and ARC (2).

**Answer (AR):** انظر vendor_performance.most_late — شريك تطوير الاستثمار (TIP) لديه أكثر بنود متأخرة (3)، يليه RGA (3) و ARC (2).

---

### `V-04` Which vendor delivers the highest quality?

أي مقاول يقدم أعلى مستوى جودة؟

**Answer (EN):** Use vendor_performance.highest_quality — Saudi Binladin Group (SBG) leads with a quality score of 92/100. They are slower on deadlines but their bridge work meets the highest spec.

**Answer (AR):** انظر vendor_performance.highest_quality — مجموعة بن لادن السعودية (SBG) في المقدمة بنتيجة جودة 92/100. أبطأ في المواعيد لكن أعمال الكباري لديها وفق أعلى مواصفات.

---

### `V-05` Who holds the largest contract on the corridor?

أي مقاول لديه أكبر قيمة عقد على المحور؟

**Answer (EN):** Use vendor_performance.largest_contract — Al-Rajhi Construction (ARC) at SAR 22.5M, followed by Tatweer Investment Partner (TIP) at SAR 18.9M and Saudi Binladin Group (SBG) at SAR 14.8M.

**Answer (AR):** انظر vendor_performance.largest_contract — شركة الراجحي للإنشاءات (ARC) بقيمة 22.5 مليون ر.س، يليها شريك تطوير الاستثمار (TIP) بـ 18.9 مليون ر.س، ثم مجموعة بن لادن السعودية (SBG) بـ 14.8 مليون ر.س.

---

### `V-06` What is the total contract value committed on the corridor across all vendors?

ما إجمالي قيمة العقود الملتزم بها على المحور لدى جميع المقاولين؟

**Answer (EN):** Use vendor_performance.total_corridor_contract_value_sar.

**Answer (AR):** انظر vendor_performance.total_corridor_contract_value_sar.

---

### `V-07` Show me the full vendor scorecard ranking.

أعرض بطاقة أداء كل المقاولين مرتبة.

**Answer (EN):** Use vendor_performance.ranked_by_composite — vendors sorted by composite score (best first). Each entry has the contractor's id, acronym, and composite score (0..100).

**Answer (AR):** انظر vendor_performance.ranked_by_composite — مقاولون مرتبون حسب النتيجة المركبة (الأفضل أولاً). كل إدخال يحوي المعرّف والاختصار والنتيجة المركبة (0..100).

---

### `V-08` Which vendor should we be most concerned about and why?

أي مقاول يجب أن نقلق منه أكثر ولماذا؟

**Answer (EN):** Tatweer Investment Partner (TIP) — lowest on-time rate among active vendors (52%), 3 late findings, SAR 320,000 in fines YTD, and 1 escalation. Combined with their large SAR 18.9M contract, this exposure warrants leadership attention. Action: schedule a contractor performance review and consider escalation in the joint working room.

**Answer (AR):** شريك تطوير الاستثمار (TIP) — أدنى نسبة التزام بالمواعيد بين المقاولين الفعّالين (52%)، 3 بنود متأخرة، 320,000 ر.س غرامات منذ بداية العام، وحالة تصعيد واحدة. مع حجم العقد الكبير (18.9 مليون ر.س)، هذه المخاطر تستحق اهتمام القيادة. الإجراء: جدولة مراجعة أداء المقاول ودراسة التصعيد في غرفة العمل المشتركة.
...
كم حجم ميزانية التطوير الملتزم بها في النطاق 8؟
...
ما نسبة الإنفاق من ميزانية النطاق 8؟
...
أي نطاق تجريبي لديه أكبر ميزانية ملتزمة؟
...
ما إجمالي ميزانية التطوير الملتزم بها لكل نطاقات التجربة؟
...
كم يوماً متبقياً حتى موسم الحج القادم؟
...
ما الأعمال قصيرة المدى التي يجب إنجازها قبل الحج؟
...
أي نطاق له أعلى أولوية لجاهزية الحج؟
...
كم عدد البنود التطويرية مقابل التشغيلية؟
...
إذا تكررت ملاحظة تشغيلية (نفس ورشة تسرّب الزيت للمرة الثالثة)، ماذا يعني ذلك؟
...
هل تستطيع الإجابة عن طرق الرياض أو مدن أخرى؟
...
هل توجد بيانات لنطاقات خارج Z8 و Z35 و Z70؟
...
هل البيانات في هذه التجربة حقيقية؟
