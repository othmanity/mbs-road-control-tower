...
const Q: KbQuestion[] = [
  ...
  },
  {
    ...
    a_en: "Port → Bahrah (0–30 km, logistics & workshops), Bahrah → Prince Nayef (30–64 km, inter-city / fuel / ad-boards / slum pockets), and Prince Nayef → Holy Mosque (64–75 km, pilgrim approach).",
  ...
  },
  {
    ...
    a_en: "Phase 5 (Z61–Z75), sub-stretch ‘Prince Nayef → Holy Mosque’.",
  ...
  },
  {
    ...
    a_en: "Phase 5, Haram approach, high distortion density. Prince Nayef Bridge perimeter restoration, inspection-point upgrade, barrier replacement. Highest leadership scrutiny before Hajj.",
  ...
  },
  {
    ...
    a_en: "Yes — Zone 70 contains Prince Nayef Bridge (approach). Asset type ‘bridge’ also appears in poc_zones[id=70].asset_count_by_type.",
  ...
  },
  {
    ...
    a_en: "Zone 70 — Prince Nayef Bridge approach is the pilgrim entry; bridge perimeter and inspection-point appearance directly shape the welcome experience.",
