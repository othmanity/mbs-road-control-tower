...
const Q: KbQuestion[] = [
  ...
  },
  {
    ...
    a_en: "Work that cannot progress because of an external dependency (e.g., utility contractor not responding, owner notice unresolved, contractor hand-off pending). These are the items the joint working room escalates first.",
  ...
  // ----------------------------- Findings by zone
  {
    ...
    a_en: "Phase 1, port stretch, high distortion density. Workshops belt with damaged median barriers and asphalt deterioration. Multiple contractors involved (ARC, JM, RGA, GDCD, MAAS, TIP).",
  ...
  // ----------------------------- Contractors / governance
  {
    ...
    q_en: "Which contractors are involved on the MBS Road?",
    q_ar: "أي مقاولين يعملون على محور طريق الأمير محمد بن سلمان؟",
    a_en: "Ten in total: six government-internal entities (MoMAH — governance owner, HCM, JM, RGA, GDT, GDCD) and four private-sector vendors (Al-Rajhi Construction — ARC, Saudi Binladin Group — SBG, MA'AS Services — MAAS, and Tatweer Investment Partner — TIP).",
    a_ar: "عشرة إجمالاً: ستة جهات حكومية داخلية (MoMAH — مالك الحوكمة، HCM، JM، RGA، GDT، GDCD) وأربعة مقاولين من القطاع الخاص (شركة الراجحي للإنشاءات — ARC، مجموعة بن لادن السعودية — SBG، ماس للخدمات — MAAS، وشريك تطوير الاستثمار — TIP).",
    data_refs: ["contractors"],
  },
  {
    id: "A-02",
    category: "contractors",
    q_en: "Which contractor owns the most findings overall?",
    q_ar: "أي مقاول يحمل أكبر عدد من الملاحظات؟",
    a_en: "Take the largest entry of findings_aggregate.by_contractor — currently TIP and MAAS share the lead with 5 each, followed by ARC at 4.",
    a_ar: "انظر أكبر إدخال في findings_aggregate.by_contractor — حالياً TIP و MAAS يتشاركان الصدارة بـ 5 ملاحظات لكل منهما، يليهما ARC بـ 4.",
    data_refs: ["findings_aggregate.by_contractor"],
  },
  {
    id: "A-03",
    category: "contractors",
    q_en: "Which contractor has the most blocked items?",
    q_ar: "أي مقاول لديه أكثر بنود متعثرة؟",
    a_en: "Compare contractors[*].blocked_findings_count and take the max — currently RGA and HCM each have 1 blocked item open.",
    a_ar: "قارن contractors[*].blocked_findings_count — حالياً RGA و HCM لدى كل منهما بند متعثر واحد مفتوح.",
    data_refs: ["contractors", "findings_aggregate.top_blockers"],
  },
  {
    id: "A-04",
    category: "contractors",
    ...
    a_en: "Because no single authority oversees the corridor end-to-end — 4 contractors involved in maintenance, 7 in infrastructure projects, 3 in studies, 4 in private-sector projects. Roles overlap and there is no joint operations room (slide 9).",
    a_ar: "لأنه لا توجد جهة واحدة مشرفة على المحور كاملاً — 4 مقاولين في الصيانة، 7 في البنية التحتية، 3 في الدراسات، 4 في القطاع الخاص. تتداخل الأدوار ولا توجد غرفة عمليات مشتركة (شريحة 9).",
    data_refs: ["contractors"],
  },
  {
    id: "A-05",
    ...
    a_en: "An independent program led by MoMAH that joins HCM (Makkah) and Jeddah Municipality in a shared working room with mandates for findings remediation, vendor performance oversight, and stakeholder coordination.",
    a_ar: "برنامج مستقل بقيادة MoMAH يجمع HCM (مكة) وأمانة جدة في غرفة عمل مشتركة بصلاحيات معالجة الملاحظات، ومتابعة أداء المقاولين، وتنسيق أصحاب المصلحة.",
    data_refs: ["contractors"],
  },
  {
    id: "A-06",
    ...
    a_en: "Tatweer Investment Partner (TIP) — a PPP vendor — under MoMAH oversight.",
    a_ar: "شريك تطوير الاستثمار (TIP) — مقاول شراكة بين القطاعين العام والخاص — تحت إشراف MoMAH.",
    data_refs: ["contractors[id=tip]"],
  },
  ...
  // ----------------------------- Vendor performance
  {
    ...
    q_en: "Who is our best-performing vendor overall?",
    q_ar: "من هو أفضل مقاول من حيث الأداء بشكل عام؟",
    a_en: "Use vendor_performance.best_overall — based on a composite score that weights on-time delivery (40%), quality (30%), low fines (20%), and few late items (10%).",
    a_ar: "انظر vendor_performance.best_overall — مبني على نتيجة مركبة تزن الالتزام بالمواعيد (40%)، الجودة (30%)، انخفاض الغرامات (20%)، وقلة البنود المتأخرة (10%).",
    data_refs: ["vendor_performance.best_overall", "vendor_performance.ranked_by_composite"],
  },
  {
    id: "V-02",
    category: "vendor_performance",
    q_en: "Which vendor has the most fines this year?",
    q_ar: "أي مقاول لديه أكبر مبلغ غرامات هذا العام؟",
    a_en: "Use vendor_performance.most_fined — Al-Rajhi Construction (ARC) leads at SAR 450,000 YTD, followed by Tatweer Investment Partner (TIP) at SAR 320,000.",
    a_ar: "انظر vendor_performance.most_fined — شركة الراجحي للإنشاءات (ARC) في المقدمة بـ 450,000 ر.س منذ بداية العام، يليها شريك تطوير الاستثمار (TIP) بـ 320,000 ر.س.",
    data_refs: ["vendor_performance.most_fined", "contractors"],
  },
  {
    id: "V-03",
    category: "vendor_performance",
    q_en: "Which vendor is slipping on deadlines / has the most late findings?",
    q_ar: "أي مقاول متأخر عن المواعيد / لديه أكثر بنود متأخرة؟",
    a_en: "Use vendor_performance.most_late — Tatweer Investment Partner (TIP) currently has the most late findings (3), followed by RGA (3) and ARC (2).",
    a_ar: "انظر vendor_performance.most_late — شريك تطوير الاستثمار (TIP) لديه أكثر بنود متأخرة (3)، يليه RGA (3) و ARC (2).",
    data_refs: ["vendor_performance.most_late", "contractors"],
  },
  {
    id: "V-04",
    category: "vendor_performance",
    q_en: "Which vendor delivers the highest quality?",
    q_ar: "أي مقاول يقدم أعلى مستوى جودة؟",
    a_en: "Use vendor_performance.highest_quality — Saudi Binladin Group (SBG) leads with a quality score of 92/100. They are slower on deadlines but their bridge work meets the highest spec.",
    a_ar: "انظر vendor_performance.highest_quality — مجموعة بن لادن السعودية (SBG) في المقدمة بنتيجة جودة 92/100. أبطأ في المواعيد لكن أعمال الكباري لديها وفق أعلى مواصفات.",
    data_refs: ["vendor_performance.highest_quality", "contractors[id=sbg]"],
  },
  {
    id: "V-05",
    category: "vendor_performance",
    q_en: "Who holds the largest contract on the corridor?",
    q_ar: "أي مقاول لديه أكبر قيمة عقد على المحور؟",
    a_en: "Use vendor_performance.largest_contract — Al-Rajhi Construction (ARC) at SAR 22.5M, followed by Tatweer Investment Partner (TIP) at SAR 18.9M and Saudi Binladin Group (SBG) at SAR 14.8M.",
    a_ar: "انظر vendor_performance.largest_contract — شركة الراجحي للإنشاءات (ARC) بقيمة 22.5 مليون ر.س، يليها شريك تطوير الاستثمار (TIP) بـ 18.9 مليون ر.س، ثم مجموعة بن لادن السعودية (SBG) بـ 14.8 مليون ر.س.",
    data_refs: ["vendor_performance.largest_contract", "contractors"],
  },
  {
    id: "V-06",
    category: "vendor_performance",
    q_en: "What is the total contract value committed on the corridor across all vendors?",
    q_ar: "ما إجمالي قيمة العقود الملتزم بها على المحور لدى جميع المقاولين؟",
    a_en: "Use vendor_performance.total_corridor_contract_value_sar.",
    a_ar: "انظر vendor_performance.total_corridor_contract_value_sar.",
    data_refs: ["vendor_performance.total_corridor_contract_value_sar"],
  },
  {
    id: "V-07",
    category: "vendor_performance",
    q_en: "Show me the full vendor scorecard ranking.",
    q_ar: "أعرض بطاقة أداء كل المقاولين مرتبة.",
    a_en: "Use vendor_performance.ranked_by_composite — vendors sorted by composite score (best first). Each entry has the contractor's id, acronym, and composite score (0..100).",
    a_ar: "انظر vendor_performance.ranked_by_composite — مقاولون مرتبون حسب النتيجة المركبة (الأفضل أولاً). كل إدخال يحوي المعرّف والاختصار والنتيجة المركبة (0..100).",
    data_refs: ["vendor_performance.ranked_by_composite", "contractors"],
  },
  {
    id: "V-08",
    category: "vendor_performance",
    q_en: "Which vendor should we be most concerned about and why?",
    q_ar: "أي مقاول يجب أن نقلق منه أكثر ولماذا؟",
    a_en: "Tatweer Investment Partner (TIP) — lowest on-time rate among active vendors (52%), 3 late findings, SAR 320,000 in fines YTD, and 1 escalation. Combined with their large SAR 18.9M contract, this exposure warrants leadership attention. Action: schedule a contractor performance review and consider escalation in the joint working room.",
    a_ar: "شريك تطوير الاستثمار (TIP) — أدنى نسبة التزام بالمواعيد بين المقاولين الفعّالين (52%)، 3 بنود متأخرة، 320,000 ر.س غرامات منذ بداية العام، وحالة تصعيد واحدة. مع حجم العقد الكبير (18.9 مليون ر.س)، هذه المخاطر تستحق اهتمام القيادة. الإجراء: جدولة مراجعة أداء المقاول ودراسة التصعيد في غرفة العمل المشتركة.",
    data_refs: ["contractors[id=tip]", "vendor_performance.most_late", "vendor_performance.most_fined"],
  },
...
export const kbCategoryLabels: Record<KbCategory, { en: string; ar: string }> = {
  ...
  contractors:        { en: "Contractors & governance",  ar: "المقاولون والحوكمة" },
  vendor_performance: { en: "Vendor performance",        ar: "أداء المقاولين" },
